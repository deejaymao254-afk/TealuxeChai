...
const openProductPopup = (product) => {
  ...
  const firstFlavour = product.variations[0];
  const firstWeight = firstFlavour.weights[0];
  ...
  >
    ...
    >
      ...
      <div className="modal-section">
        ...
        >
          {selectedFlavour?.weights.map((w, i) => (
            <option key={i} value={w.weight}>
      ...
      <div className="modal-section">
        ...
        <div style={{ marginTop: "10px", textAlign: "right" }}>
          <span style={{ fontWeight: 600 }}>
            Unit Snacks: {quantity * 48} pcs
          </span>
          <br />
          <span style={{ fontWeight: 700, color: "var(--accent-color)" }}>
            Total: KES {(unitPrice * quantity * 48).toLocaleString()}
          </span>
        </div>
      </div>
